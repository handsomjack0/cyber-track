...
const ResourceListView: React.FC<ResourceListViewProps> = ({
  ...
  const filteredResources = resources.filter((r) => {
    ...
    if (searchQuery.trim()) {
      ...
      return r.name.toLowerCase().includes(query) || r.provider.toLowerCase().includes(query);
    }
    return true;
  });
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 blueprint-card p-5">
        ...
        <div>
          <div className="text-xs uppercase tracking-[0.2em] text-indigo-500 font-semibold">Resources</div>
